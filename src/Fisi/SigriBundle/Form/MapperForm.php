...
class MapperForm {
    ...
    public static function convertirFormANuevaSolicitud($data, $estado,$prioridad, $empleado,$ip){
    ...
    public static function convertirFormANuevaCategoria($data){
        //se crea la entidad solicitud
        $categoria = new Categoria();
        //se agregan los valores de los atributos
        $categoria->setNombrecategoria($data['nombreNuevaCategoria']);
        $categoria->setDescripcioncategoria($data['descripcionNuevaCategoria']);        
        return $categoria;
    }
